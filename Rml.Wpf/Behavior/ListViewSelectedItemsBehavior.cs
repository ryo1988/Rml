...
namespace Rml.Wpf.Behavior
{
    ...
    public class ListViewSelectedItemsBehavior : Behavior<ListView>
    {
        ...
        public static readonly DependencyProperty SelectedItemsProperty = DependencyProperty.Register(
            "SelectedItems", typeof(Array), typeof(ListViewSelectedItemsBehavior), new FrameworkPropertyMetadata(default(Array), FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, SelectedItemsPropertyChanged));
