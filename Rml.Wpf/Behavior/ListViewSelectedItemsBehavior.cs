...
namespace Rml.Wpf.Behavior
{
    ...
    public class ListViewSelectedItemsBehavior : Behavior<ListView>
    {
        ...
        public static readonly DependencyProperty SelectedItemsProperty = DependencyProperty.Register(
            "SelectedItems", typeof(IList), typeof(ListViewSelectedItemsBehavior), new FrameworkPropertyMetadata(default(IList), FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, SelectedItemsPropertyChanged));

        private static void SelectedItemsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var self = (ListViewSelectedItemsBehavior)d;
        ...
        public static readonly DependencyProperty ElementTypeProperty = DependencyProperty.Register(
            "ElementType", typeof(Type), typeof(ListViewSelectedItemsBehavior), new PropertyMetadata(default(Type)));
